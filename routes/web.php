...
Route::get('/fruit.html',[CategoryController::class,'indexfruit'] )->name('product.all');
Route::post('/search',[CategoryController::class,'search'] )->name('product.search');
Route::get('/fruit',[CategoryController::class,'indexfruitDK'] )->name('product.dm');
Route::get('/chitietsanpham',[CategoryController::class,'chitietsp'] )->name('chitietsp');
...
Route::get('/don-hang-cua-ban',[CategoryController::class,'donhanguser'])->name('donhanguser')->middleware(['auth']);
Route::get('/chi-tiet-don-hang-cua-ban',[CategoryController::class,'chitietdonhanguser'])->name('chitietdonhanguser')->middleware(['auth']);
...
Route::get('/Dathang', function () {
    if(auth()->check()){
        ...
        return view('hoanthanh')->with('hover',$hover);
    }else{
...
Route::get('/thanhtoan.html', function () {
    ...
    $hover=Cart::where('id_user',auth()->user()->id)->get();
    return view('thanhtoan')->with('hover',$hover)->with('cart',$cart);
